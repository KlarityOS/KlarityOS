  ...
  return (
    <div>
      ...
      <div style={{ textAlign: 'right', marginBottom: '20px' }}>
        <span style={{ margin: '0 15px', cursor: 'pointer', fontSize: '16px', fontWeight: 'bold' }}>Upload Files</span>
        <span style={{ margin: '0 15px', cursor: 'pointer', fontSize: '16px', fontWeight: 'bold' }}>Client Portal</span>
        <span style={{ margin: '0 15px', cursor: 'pointer', fontSize: '16px', fontWeight: 'bold' }}>Home</span>
      </div>
      <iframe
