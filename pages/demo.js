  ...
  return (
    <div>
      ...
      <div style={{ textAlign: 'right', marginBottom: '40px' }}>
        <span style={{ margin: '0 20px', cursor: 'pointer', fontSize: '16px' }}>UPLOAD FILES</span>
        <span style={{ margin: '0 20px', cursor: 'pointer', fontSize: '16px' }}>CLIENT PORTAL</span>
        <a href="https://klarityos.vercel.app/beta" style={{ margin: '0 20px', cursor: 'pointer', fontSize: '16px', textDecoration: 'none', color: 'inherit' }}>HOME</a>
      </div>
      <iframe
